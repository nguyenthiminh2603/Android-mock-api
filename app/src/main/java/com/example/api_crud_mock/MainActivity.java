...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<Adress> arrayList;



    ListView lv;
    Button btnClick;
    TextView tvDisplay;    String url = "https://5fd065ab1f237400166316ec.mockapi.io/Adress/";

     //String url = "https://5fd065ab1f237400166316ec.mockapi.io/Adress/1";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* adapter=new ArrayAdapter(this, android.R.layout.simple_list_item_1,arrayList1);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            tvDisplay.setText(response.getString("city").toString());
                ...
                for(int i=0; i<response.length(); i++){
                    ...
                    try {
                        JSONObject object = (JSONObject) response.get(i);
                         ...
                         adress.setId(object.getString("id"));
                         adress.setCity(object.getString("city"));
                         adress.setCountry(object.getString("country"));
